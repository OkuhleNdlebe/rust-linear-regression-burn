...
use burn_autodiff::AutodiffBackendCpu;  // ✅ Use AutodiffBackendCpu
use rand::Rng;
...
fn train_model<B: AutodiffBackend>() {
    ...
    let mut optimizer = Adam::new(optim_config); // Corrected initialization
...
fn main() {
    train_model::<AutodiffBackendCpu>(); // ✅ Use AutodiffBackendCpu
}
